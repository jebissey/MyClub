...
INSERT INTO "Test" VALUES (99,1050,'GET','/user/groups',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
...
INSERT INTO "Test" VALUES (109,1150,'GET','/eventTypes',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (110,1160,'GET','/needs',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (111,1170,'GET','/registration',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (112,1180,'GET','/referents',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (113,1190,'GET','/topPages',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (114,1200,'GET','/crossTab',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (115,1210,'GET','/logs',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (116,1220,'GET','/lastVisits',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (117,1230,'GET','/admin/webmaster/help',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (118,1032,'POST','/user/account',NULL,'{"email":"webmaster%40myclub.foo", "firstName":"fn", "lastName":"ln", "nickName":"", "avatar":"%F0%9F%98%82"}','{"email":"webmaster@myclub.foo","password":"admin1234" }','303','SELECT Email, FirstName, LastName, NickName, Avatar From Person','[{"Email":"webmaster%40myclub.foo","FirstName":"fn","LastName":"ln","NickName":"","Avatar":"🤔"}]');
COMMIT;
