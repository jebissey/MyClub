...
INSERT INTO "Test" VALUES (119,1080,'POST','/user/availabilities',NULL,'{"availabilities":{"4":{"morning":"on"},"5":{"morning":"on"},"0":{"evening":"on"},"2":{"evening":"on"}}}','{"email":"webmaster@myclub.foo","password":"admin1234" }','303','SELECT Availabilities From Person','[{"Availabilities":"{\"4\":{\"morning\":\"on\"},\"5\":{\"morning\":\"on\"},\"0\":{\"evening\":\"on\"},\"2\":{\"evening\":\"on\"}}"}]');
INSERT INTO "Test" VALUES (120,1130,'POST','/user/preferences',NULL,'{"preferences":{"eventTypes":{"newEvent":{"enabled":"on"},"newArticle":{"enabled":"on","pollOnly":"on"}}}}','{"email":"webmaster@myclub.foo","password":"admin1234" }','303','SELECT Preferences From Person','[{"Preferences":"{\"eventTypes\":{\"newEvent\":{\"enabled\":\"on\"},\"newArticle\":{\"enabled\":\"on\",\"pollOnly\":\"on\"}}}"}]');
...
INSERT INTO "Test" VALUES (123,1190,'POST','/user/presentation/edit',NULL,'{"content":"<p>my présentation</p>","location":"47.32326658122776,5.0348684191703805","inPresentationDirectory":"on"}','{"email":"webmaster@myclub.foo","password":"admin1234" }','303','SELECT Presentation, Location, InPresentationDirectory From Person','[{"Presentation":"<p>my présentation<\/p>","Location":"47.32326658122776,5.0348684191703805","InPresentationDirectory":1}]');
