...
INSERT INTO "Test" VALUES (97,1040,'GET','/user/account',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (98,1070,'GET','/user/availabilities',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (99,1100,'GET','/user/groups',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200','SELECT * From "Group"','[{"Id":1,"Name":"Webmaster","Inactivated":0,"SelfRegistration":0}]');
INSERT INTO "Test" VALUES (100,1120,'GET','/user/preferences',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (101,1150,'GET','/user/statistics',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (102,1160,'GET','/user/directory',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
...
INSERT INTO "Test" VALUES (110,1410,'GET','/needs',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (111,1360,'GET','/registration',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (112,1420,'GET','/referents',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (113,1430,'GET','/topPages',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (114,1440,'GET','/crossTab',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (115,1450,'GET','/logs',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (116,1460,'GET','/lastVisits',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (117,1380,'GET','/admin/webmaster/help',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (118,1050,'POST','/user/account',NULL,'{"email":"webmaster%40myclub.foo", "firstName":"fn", "lastName":"ln", "nickName":"", "avatar":"%F0%9F%98%82"}','{"email":"webmaster@myclub.foo","password":"admin1234" }','302','SELECT Email, FirstName, LastName, NickName, Avatar From Person','[{"Email":"webmaster@myclub.foo","FirstName":"fn","LastName":"ln","NickName":"","Avatar":"🤔"}]');
INSERT INTO "Test" VALUES (119,1080,'POST','/user/availabilities',NULL,'{"availabilities":{"4":{"morning":"on"},"5":{"morning":"on"},"0":{"evening":"on"},"2":{"evening":"on"}}}','{"email":"webmaster@myclub.foo","password":"admin1234" }','302','SELECT Availabilities From Person','[{"Availabilities":"{\"4\":{\"morning\":\"on\"},\"5\":{\"morning\":\"on\"},\"0\":{\"evening\":\"on\"},\"2\":{\"evening\":\"on\"}}"}]');
INSERT INTO "Test" VALUES (120,1130,'POST','/user/preferences',NULL,'{"preferences":{"eventTypes":{"newEvent":{"enabled":"on"},"newArticle":{"enabled":"on","pollOnly":"on"}}}}','{"email":"webmaster@myclub.foo","password":"admin1234" }','302','SELECT Preferences From Person','[{"Preferences":"{\"eventTypes\":{\"newEvent\":{\"enabled\":\"on\"},\"newArticle\":{\"enabled\":\"on\",\"pollOnly\":\"on\"}}}"}]');
INSERT INTO "Test" VALUES (121,1390,'GET','/user/sign/out',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','302',NULL,NULL);
INSERT INTO "Test" VALUES (122,1170,'GET','/user/presentation/edit',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (123,1190,'POST','/user/presentation/edit',NULL,'{"content":"<p>my présentation</p>","location":"47.32326658122776,5.0348684191703805","inPresentationDirectory":"on"}','{"email":"webmaster@myclub.foo","password":"admin1234" }','302','SELECT Presentation, Location, InPresentationDirectory From Person','[{"Presentation":"<p>my présentation<\/p>","Location":"47.32326658122776,5.0348684191703805","InPresentationDirectory":1}]');
INSERT INTO "Test" VALUES (124,1180,'GET','/user/presentation/edit',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (125,1200,'GET','/user/directory?group=1',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (126,1210,'GET','/user/directory?group=1',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (127,1220,'GET','/user/news',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (128,1240,'GET','/user/news?from=month',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (129,1250,'GET','/webmaster',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (130,1270,'GET','/dbbrowser',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (131,1290,'GET','/navBar',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (132,1310,'GET','/arwards',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (133,1330,'GET','/groups',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (134,1350,'GET','/registration',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (135,1370,'GET','/admin/webmaster/help',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (136,1030,'GET','/user/account',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (137,1060,'GET','/user/availabilities',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (138,1090,'GET','/user/groups',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (139,1110,'GET','/user/preferences',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (140,1140,'GET','/user/statistics',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (141,1398,'GET','/eventTypes',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (142,1408,'GET','/needs',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (143,1418,'GET','/referents',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (144,1428,'GET','/topPages',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (145,1438,'GET','/crossTab',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (146,1448,'GET','/logs',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (147,1458,'GET','/lastVisits',NULL,NULL,NULL,'403',NULL,NULL);
COMMIT;
