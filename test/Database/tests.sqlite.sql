...
INSERT INTO "Test" VALUES (98,1050,'GET','/user/availabilities',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (99,1070,'GET','/user/groups',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200','SELECT * From "Group"','[{"Id":1,"Name":"Webmaster","Inactivated":0,"SelfRegistration":0}]');
INSERT INTO "Test" VALUES (100,1080,'GET','/user/preferences',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (101,1100,'GET','/user/statistics',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (102,1110,'GET','/user/directory',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (103,1140,'GET','/user/news',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (104,1150,'GET','/webmaster',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (105,1160,'GET','/dbbrowser',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (106,1170,'GET','/navBar',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (107,1180,'GET','/arwards',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (108,1190,'GET','/groups',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (109,1230,'GET','/eventTypes',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (110,1240,'GET','/needs',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (111,1200,'GET','/registration',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (112,1250,'GET','/referents',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (113,1260,'GET','/topPages',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (114,1270,'GET','/crossTab',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (115,1280,'GET','/logs',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (116,1290,'GET','/lastVisits',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (117,1210,'GET','/admin/webmaster/help',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
INSERT INTO "Test" VALUES (118,1040,'POST','/user/account',NULL,'{"email":"webmaster%40myclub.foo", "firstName":"fn", "lastName":"ln", "nickName":"", "avatar":"%F0%9F%98%82"}','{"email":"webmaster@myclub.foo","password":"admin1234" }','303','SELECT Email, FirstName, LastName, NickName, Avatar From Person','[{"Email":"webmaster@myclub.foo","FirstName":"fn","LastName":"ln","NickName":"","Avatar":"🤔"}]');
INSERT INTO "Test" VALUES (119,1060,'POST','/user/availabilities',NULL,'{"availabilities":{"4":{"morning":"on"},"5":{"morning":"on"},"0":{"evening":"on"},"2":{"evening":"on"}}}','{"email":"webmaster@myclub.foo","password":"admin1234" }','303','SELECT Availabilities From Person','[{"Availabilities":"{\"4\":{\"morning\":\"on\"},\"5\":{\"morning\":\"on\"},\"0\":{\"evening\":\"on\"},\"2\":{\"evening\":\"on\"}}"}]');
INSERT INTO "Test" VALUES (120,1090,'POST','/user/preferences',NULL,'{"preferences":{"eventTypes":{"newEvent":{"enabled":"on"},"newArticle":{"enabled":"on","pollOnly":"on"}}}}','{"email":"webmaster@myclub.foo","password":"admin1234" }','303','SELECT Preferences From Person','[{"Preferences":"{\"eventTypes\":{\"newEvent\":{\"enabled\":\"on\"},\"newArticle\":{\"enabled\":\"on\",\"pollOnly\":\"on\"}}}"}]');
INSERT INTO "Test" VALUES (121,1220,'GET','/user/sign/out',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','302',NULL,NULL);
INSERT INTO "Test" VALUES (122,1120,'GET','/user/presentation/edit',NULL,NULL,NULL,'403',NULL,NULL);
INSERT INTO "Test" VALUES (123,1130,'POST','/user/presentation/edit',NULL,'{"content":"<p>my présentation</p>","location":"47.32326658122776,5.0348684191703805","inPresentationDirectory":"on"}','{"email":"webmaster@myclub.foo","password":"admin1234" }','303','SELECT Presentation, Location, InPresentationDirectory From Person','[{"Presentation":"<p>my présentation<\/p>","Location":"47.32326658122776,5.0348684191703805","InPresentationDirectory":1}]');
INSERT INTO "Test" VALUES (124,1122,'GET','/user/presentation/edit',NULL,NULL,'{"email":"webmaster@myclub.foo","password":"admin1234" }','200',NULL,NULL);
COMMIT;
