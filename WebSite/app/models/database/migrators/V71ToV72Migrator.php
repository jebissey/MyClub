...
final class V71ToV72Migrator implements DatabaseMigratorInterface
{
...
('event.cancelled',                 
    '(Event Cancelled)', '(Evénement Annulé)', '(Wydarzenie Odwołane)'),
('event.login_required',               
    'You must be logged in to register for this event.',       
    "Il faut être connecté pour pouvoir s'inscrire à cet événement.", 
    'Musisz być zalogowany, aby zapisać się na to wydarzenie.'),
('event.open_google_maps',             
    'Open in Google Maps',                                     
    'Ouvrir dans Google Maps',                                        
    'Otwórz w Google Maps'),
('event.update_calendar',              
    'Easily update your personal calendar:',                   
    'Mettez facilement à jour votre agenda personnel :',              
    'Łatwo zaktualizuj swój osobisty kalendarz:'),
('event.cancelled_calendar_disabled',  
    'This event is cancelled, adding to calendar is disabled.',
    "Cet événement est annulé, l'ajout à l''agenda est désactivé.",  
    'To wydarzenie jest odwołane, dodawanie do kalendarza jest wyłączone.'),
('event.needs',                        
    'Event needs',                                             
    'Besoins de l''événement',                                        
    'Potrzeby wydarzenia'),
('event.needs_click_to_edit',          
    'Click on quantities to edit your contributions',         
    'Cliquez sur les quantités pour modifier vos apports',            
    'Kliknij na ilości, aby edytować swoje wkłady'),
('event.needs_per_participant',        
    'per participant',                                         
    'par participant',                                                
    'na uczestnika'),
